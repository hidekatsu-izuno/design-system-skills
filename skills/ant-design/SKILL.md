...
- Make row-level actions, alert-panel actions, and summary-card navigation visibly interactive using links, buttons, or action-card affordances instead of static text.
